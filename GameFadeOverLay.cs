...
namespace KirbyNightmareInDreamLand
{
	public class GameOverLay
	{
        ...
        public void DrawFade(SpriteBatch spriteBatch, Rectangle bounds, float alphaFade)
        {
            ...
            GameDebug.Instance.DrawSolidRectangle(spriteBatch, bounds, new Color(a, a, a, 0), 1f);
        }
    }
