...
Left and right arrows move Kirby and 'x' and down arrow allow him to jump and crouch respectively.
Two consecutive left or right arrow presses (either hold then press or press press) makes Kirby run.
The 'a' and 'd' keys change Kirby's facing direction. We did not implement 'w' and 's' keys bc Kirby never faces up or down.
...
Use 'e' to cause Kirby to take damage and get "thrown" until other movement is executed or he hits the edge of the screen.
