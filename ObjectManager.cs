...
namespace KirbyNightmareInDreamLand
{
    public class ObjectManager
    {
        ...
        public IEnemy waddledeeTest { get; set; }
        public IEnemy waddledooTest { get; set; }
        public IEnemy brontoburtTest { get; set; }
        public IEnemy hotheadTest { get; set; }
        public IEnemy poppybrosjrTest { get; set; }
        public IEnemy sparkyTest { get; set; }
