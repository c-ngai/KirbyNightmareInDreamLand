...
{
    public class KirbyBriefcase : IProjectile, ICollidable, IExplodable
    {
        ...
        public KirbyBriefcase(IPlayer _player, Vector2 pos, bool isLeft)
        {
            player = _player;
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            if (windup)
            {
                ...
                position = player.GetKirbyPosition();
                windupSprite.Draw(position, spriteBatch);
            }
            // if in midair stage
            else if (!exploded)
            {
